...
// Fungsi untuk memampatkan HTML
function sanitize_output($buffer) {
    $search = array(
        '/\>[^\S ]+/s',     // hapus spasi setelah tag, kecuali spasi
        '/[^\S ]+\</s',     // hapus spasi sebelum tag, kecuali spasi
        '/(\s)+/s',         // memampatkan spasi
    ...
    <div class="footer-foreground">
      <div class="footercontainer">
        ...
        <div class="social-media-container">
          ...
          <div class="logos">
          <a href="https://www.instagram.com/aethersss17/" target="_blank" tabindex="0" aria-label="My instagram"><svg viewBox="0 0 448 512" class="SocialHandle">
                <path
